...
class App extends BaseConfig
{
    ...
    /**
     * Constructor de la clase, el cual permite indicar la ruta de nuestra aplicación a partir de la variable
     *      de entorno ip_pub creada en el proceso de generación del Docker
     */
    public function __construct(){
        $this->baseURL = 'http://'.$_ENV["ip_pub"].'/';
    }
}
